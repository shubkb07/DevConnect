...
try {
    ...
    $table_queries = [
        "{$table_prefix}users" => "CREATE TABLE IF NOT EXISTS {$table_prefix}users (
            ...
            user_reputaion int(11) NOT NULL DEFAULT '0',
        ...
        "{$table_prefix}posts" => "CREATE TABLE IF NOT EXISTS {$table_prefix}posts (
            ...
            post_positive int(11) NOT NULL DEFAULT '0',
            post_negative int(11) NOT NULL DEFAULT '0',
        ...
        "{$table_prefix}comments" => "CREATE TABLE IF NOT EXISTS {$table_prefix}comments (
            ...
            comment_positive int(11) NOT NULL DEFAULT '0',
            comment_negative int(11) NOT NULL DEFAULT '0',
