 ...
 * @param boolean $strict   Optional. If true, only alphanumeric characters are allowed. Default false.
 *
...
}//end sanitize_title_with_dashes()
...
function sanitize_hex_color_no_hash(string $color): ?string
{
	...
	return NULL;
}//end sanitize_hex_color_no_hash()
